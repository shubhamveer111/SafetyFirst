...
<html lang="zxx">
<head>
    <title>SafetyFirst||My Profile-Dashboard</title>
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active">My Profile Details</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-8 col-md-8">
                                <div class="tab-content my-account-tab" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel"
                                     ...
                                     <a href="track-order.php" style="float:right;">Search Your Order</a>
                              
                                            <div class="welcome-dashboard m-t-30">
                                               <p>Welcome...!!!, <strong><?php  echo $row['FirstName'];?> <?php  echo $row['LastName'];?> 
