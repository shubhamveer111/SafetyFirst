...
<head>
    <title>SafetyFirst||Wishlist</title>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <?php 
$userid= $_SESSION['msmsuid'];
$query=mysqli_query($con,"select product.Image1,product.ProductName,product.CategoryName,product.Price,wishlist.ProductId,wishlist.ID from wishlist join product on product.ID=wishlist.ProductId where wishlist.UserId='$userid'");
...
?>
                                    <td class="product-thumbnail">
                                        <a href="single.php?pid=<?php  echo $row['ProductId'];?>"><img class="img-fluid" src="admin/images/<?php echo $row['Image1'];?>" width="150" height="150" alt=""></a>
                                    </td>
                                    <td class="product-name"><a href="single.php?pid=<?php  echo $row['ProductId'];?>"><?php echo $row['ProductName'];?></a></td>
                                    ...
                                    <a href="cart.php" class="btn btn--box btn--small btn--blue btn--uppercase btn--weight">Add to Cart</a>
<?php } else {?>
    <form method="post"> 
