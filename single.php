...
if(isset($_POST['review']))
  {
    ...
    $query=mysqli_query($con, "insert into productreview(ProductID,ReviewTitle,Reviews,Name) values('$pid','$reviewtitle','$reviews','$name')");
    if ($query) {
...
<html lang="zxx">
<head>
    <title>SafetyFirst||View  Product</title>
    <!-- Vendor CSS Files -->
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active">Product Information Page</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="product-details-box">
                                    ...
                                    <span class="text-reference">Category: <?php echo $row['CategoryName'];?></span>
                                    <div class="review-box">
                                         <?php
                            $pid=$_GET['pid'];
$ret2=mysqli_query($con,"select * from productreview where ProductID='$pid' && Status='Review Accept'");
...
?>
                                    ...
                                    <div class="product-var p-t-30">
                                        ...
                                        <div class="product-color product-var__item">
                                            <span class="product-var__text">Product Type: <?php echo $row['Description'];?></span>
                                            ...
                                            <div class="table-responsive-md">
                                                <table class="product-dis__list table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="product-dis__title">Category Name</td>
                                                            <td class="product-dis__text"><?php echo $row['CategoryName'];?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="product-dis__title">Product Name</td>
                                                            <td class="product-dis__text"><?php echo $row['ProductName'];?></td>
                                                        </tr>
                                                        <tr> 
                                                            <td class="product-dis__title">Product Type</td>
                                                            <td class="product-dis__text"><?php echo $row['Description'];?></td>
                                                        </tr>
                                                        <tr> 
                                                            <td class="product-dis__title">Price(per kg)</td>
                                                            <td class="product-dis__text"><?php echo $row['Price'];?></td>
                                                        </tr>
...
$ret=mysqli_query($con,"select * from productreview where ProductID='$pid' && Status='Review Accept'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
?>
                                                    ...
                                                    <div class="comment__content">
                                                        ...
                                                        <p class="para__text">*<?php echo $row['ReviewTitle'];?> </p>
                                                            <p class="para__text"><?php echo $row['Reviews'];?> </p>
...
?>
                            ...
                            <div class="col-md-6">
                                ...
                                <form action="#" method="post" class="form-box">
                                    ...
                                    <textarea id="reviews" rows="5" name="reviews" required="true"></textarea>
                                  </div>
                                    <div class="form-box__single-group">
