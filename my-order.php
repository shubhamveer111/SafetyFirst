...
<body>
 ...
 $query=mysqli_query($con,"select * from  tblorder  where UserId='$userid'");
$cnt=1;
...
?>
 <a  href="javascript:void(0);" onClick="popUpWindow('trackorder.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Track order">View details</a></li></td>
