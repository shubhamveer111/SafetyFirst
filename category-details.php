...
<head>
    <title>SafetyFirst||Products</title>
...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active">Products </li>
                    </ul>
                </div>
            </div>
        </div>
 ...
 if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM product where CategoryName='$bname'");
    $total_records = mysqli_fetch_array($result_count);
    $total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
    $second_last = $total_no_of_pages - 1; // total page minus 1
                    
$ret=mysqli_query($con,"select * from product where CategoryName='$bname' LIMIT $offset, $total_records_per_page");
$cnt=1;
                            ...
                            <div class="col-12">
                                <div class="banner__box">
                                    <a href="single-1.html" class="banner__link">
                                        <img src="assets/img/Firebaneerimg.jpg"  alt="" class="banner__img">
                                    </a>
                                </div>
                            </div>
                        </div>
