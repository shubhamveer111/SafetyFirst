...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into contactus(Name,Email,Message) value('$name','$email','$message')");
    if ($query) {
...
<html lang="zxx">
<head>
    <title>SafetyFirst||Contact Page</title>
    ...
    <main id="main-container" class="main-container">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div id="map">
                        <img src="assets/img/Dash.png" height="500" width="870" alt="" class="banner__img">
                    </div>
                </div>
