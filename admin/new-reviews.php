...
<html lang="en">
<head>
<title>Flour Milling System|| New Reviews</title>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
$ret=mysqli_query($con,"select productreview.ID,productreview.ProductID,productreview.ReviewTitle,productreview.Name,productreview.DateofReview,product.ProductName from productreview join product on product.ID=productreview.ProductID where productreview.Status is null");
$cnt=1;
