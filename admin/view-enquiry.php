...
$vid=$_GET['viewid'];
$isread=1;
$query=mysqli_query($con, "update   contactus set IsRead ='$isread' where ID='$vid'");
...
<html lang="en">
<head>
<title>Flour Milling System|| View Enquiry</title>
...
$ret=mysqli_query($con,"select * from contactus where ID=$vid");
$cnt=1;
