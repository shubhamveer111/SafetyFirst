...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="all-order.php" class="current">All Reviews</a> </div>
    <h1>All Reviews</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
$ret=mysqli_query($con,"select productreview.ID,productreview.ProductID,productreview.ReviewTitle,productreview.Name,productreview.DateofReview,product.ProductName from productreview join product on product.ID=productreview.ProductID");
$cnt=1;
