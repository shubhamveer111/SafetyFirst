<!--Header-part-->
<div id="header">
  <h2 style="padding-top: 20px;padding-left: 10px"><a href="dashboard.php"><strong style="color: white">SafetyFirst</strong></a></h2>
</div>
<!--close-Header-part-->
...
$ret=mysqli_query($con,"select AdminName from admin");
