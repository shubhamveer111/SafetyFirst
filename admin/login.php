...
$password=md5($_POST['newpassword']);
    ...
    if($ret>0){
      ...
      $query1=mysqli_query($con,"update admin set Password='$password'  where  Email='$email' && MobileNumber='$contactno'");
       if($query1)
   {
...
<head>
        <title>SafetyFirst|| Login Page</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post">
				 <div class="control-group normal_text"> <h3></strong> <strong style="color: orange">Safety First</strong></h3></div>
