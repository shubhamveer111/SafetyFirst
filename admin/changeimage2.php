...
$images=md5($images).time().$extension;
 move_uploaded_file($_FILES["images"]["tmp_name"],"images/".$images);
    $query=mysqli_query($con, "update product set Image2='$images' where ID='$eid'");
    if ($query) {
...
<html lang="en">
<head>
<title>FMS|| Update Products</title>
...
?>
           <div class="control-group">
            ...
            <div class="control-group">
              <label class="control-label">Old Image2 :</label>
              <div class="controls">
                <img src="images/<?php echo $row['Image2'];?>" width="100" height="100" value="<?php echo $row['Image2'];?>>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">New Image2 :</label>
              <div class="controls">
