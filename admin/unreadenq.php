...
<html lang="en">
<head>
<title>Flour Milling System|| Unread Enquiry</title>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="all-order.php" class="current">Unread Enquiry</a> </div>
              ...
              <thead>
                <tr>
                   ...
                   <th style="color: blue;font-size: 16px">Name</th>
                    ...
                    <th style="color: blue;font-size: 16px">Enquiry Date</th>
                     <th style="color: blue;font-size: 16px">Action</th>
                  </tr>
              </thead>
              <tbody>
                <?php
$ret=mysqli_query($con,"select * from contactus where IsRead is null");
$cnt=1;
