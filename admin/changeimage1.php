...
$images=md5($images).time().$extension;
 move_uploaded_file($_FILES["images"]["tmp_name"],"images/".$images);
    $query=mysqli_query($con, "update product set Image1='$images' where ID='$eid'");
    if ($query) {
...
?>
           <div class="control-group">
            ...
            <div class="control-group">
              <label class="control-label">Old Image1 :</label>
              <div class="controls">
                <img src="images/<?php echo $row['Image1'];?>" width="100" height="100" value="<?php echo $row['Image1'];?>>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">New Image1 :</label>
              <div class="controls">
