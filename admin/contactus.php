...
$timing=$_POST['timing'];
    ...
    $query=mysqli_query($con,"update infopages set PageTitle='$pagetitle',Email='$email',MobileNumber='$mobnumber',Timing='$timing',PageDescription='$pagedes' where  PageType='contactus'");
    if ($query) {
...
<html lang="en">
<head>
<title>SafetyFirst|| Contact Us</title>
