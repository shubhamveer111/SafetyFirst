...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update   productreview set Status='$ressta',Remark='$ressta' where ID='$rid'");
    if ($query) {
...
<html lang="en">
<head>
<title>Flour Milling System|| View Reviews</title>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="all-review.php" class="current">View Reviews</a> </div>
    <h1>View Reviews</h1>
  </div>
      ...
      <div class="span12">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
             <?php
 $rid=$_GET['rid'];
$ret=mysqli_query($con,"select productreview.ID,productreview.ProductID,productreview.ReviewTitle,productreview.Name,productreview.DateofReview,productreview.Reviews,productreview.Remark,productreview.Status,product.ProductName,product.CategoryName from productreview join product on product.ID=productreview.ProductID where productreview.ID='$rid'");
$cnt=1;
...
<td colspan="2" style="font-size:20px;color:blue">
 ...
 <tr>
    <th style="color: blue;font-size: 16px">Review By</th>
    <td><?php  echo $row['Name'];?></td>
    <th style="color: blue;font-size: 16px">Review Title</th>
    <td><?php  echo $row['ReviewTitle'];?></td>
  </tr>
  <tr>
    <th style="color: blue;font-size: 16px">Review</th>
...
<tr>
    <th style="color: blue;font-size: 16px">Remark :</th>
    <td colspan="6">
