...
<html lang="en">
<head>
<title>Flour Milling System|| On The Way Orders</title>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="all-order.php" class="current">On The Way Orders</a> </div>
    <h1>On The Way Orders</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
$ret=mysqli_query($con,"select * from tblorder join customer on customer.ID=tblorder.UserId where OrderFinalStatus='On The Way'" );
$cnt=1;
