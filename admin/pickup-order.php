...
<html lang="en">
<head>
<title>Flour Milling System|| Pick Up Orders</title>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="all-order.php" class="current">Pick Up Orders</a> </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
$ret=mysqli_query($con,"select * from tblorder join customer on customer.ID=tblorder.UserId where OrderFinalStatus='Mobile Pickup'" );
$cnt=1;
