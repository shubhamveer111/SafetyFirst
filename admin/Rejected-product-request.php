...
<html lang="en">
<head>
<title>SF|| Rejected Product Request</title>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="all-order.php" class="current">Rejected product Request</a> </div>
    <h1>Rejected Product Request</h1>
  </div>
      ...
      <div class="span12">
        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Rejected Product Request</h5>
          </div>
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
$ret=mysqli_query($con,"select * from productrequest join customer on customer.ID=productrequest.UserId where RequestFinalStatus='Request Rejected'" );
$cnt=1;
