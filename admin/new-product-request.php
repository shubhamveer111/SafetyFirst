...
<html lang="en">
<head>
<title>Flour Milling System|| New Orders</title>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="all-product-request.php" class="current">New Mill Request</a> </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
$ret=mysqli_query($con,"select * from productrequest join customer on customer.ID=productrequest.prid where RequestFinalStatus is NULL" );
$cnt=1;
