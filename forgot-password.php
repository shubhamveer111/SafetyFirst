...
$password=md5($_POST['newpassword']);
        $query=mysqli_query($con,"select ID from customer where  Email='$email' and MobileNumber='$contactno' ");
        
    $ret=mysqli_num_rows($query);
    if($ret>0){
      $_SESSION['contactno']=$contactno;
      $_SESSION['email']=$email;
      $query1=mysqli_query($con,"update customer set Password='$password'  where  Email='$email' && MobileNumber='$contactno' ");
       if($query1)
   {
...
<html lang="zxx">
<head>
    <title>Flour Milling System | Forgot Page</title>
