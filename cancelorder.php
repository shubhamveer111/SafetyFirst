...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update   tblorder set OrderFinalStatus='$ressta' where Ordernumber='$orderid'");
    if ($query) {
...
<?php  
$orderid=$_GET['oid'];
$query=mysqli_query($con,"select Ordernumber,OrderFinalStatus from tblorder where Ordernumber='$orderid'");
...
<?php 
     ...
     <?php if($status=="Wait for confirmation" ) {?>
<form method="post">
      <table>
        <tr>
