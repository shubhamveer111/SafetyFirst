...
<html lang="zxx">
<head>
    <title>Flour Milling System | Track Order</title>
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active">Search Order</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
               <div class="col-12">
                ...
                <div class="login-register-area">
                    ...
                    <h5>Search Your Order by your provided order number.</h5>
                </div>
                                                      <div class="main_title">
                   <form action="" method="post">
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" id="searchdata" name="searchdata" placeholder="Search Your Order" required='True'>
                            </div>
